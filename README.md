...
| **Training Division** | Gestión de **academias**: cada academia es un **enlace único** con su **tipo** (Rápida/AMTP, Convencional, Reingreso o Personalizado) y su **dificultad** (cuántas fáciles/medias/difíciles + duración), que define la TD. El aspirante (DUSMT) abre el enlace, pone su Nombre_Apellido y al estar listo corren los 20 min. Opción múltiple, autoenvío al agotar el tiempo, respuestas que se bloquean al marcarse y **corrección en el servidor**. La TD ve quién respondió por academia, lista de aspirantes y banco de ~106 preguntas editable (Directive+). |
